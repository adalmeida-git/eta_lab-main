...
class TestPhonebook:
    ...
    def test_get_names(self):
        phonebook = Phonebook()
        phonebook.add("Andre", "12345678")
        resultado_esperado = {'POLICIA', 'Andre'}
    ...
    def test_get_phonebook_sorted(self):
        phonebook = Phonebook()
        phonebook.add("Zuelo", "000")
        phonebook.add("Caio", "111")
        resultado_esperado = ['Caio', 'POLICIA', 'Zuelo']
    ...
    def test_get_phonebook_reverse(self):
        ...
        phonebook.add("Zuelo", "000")
        phonebook.add("Caio", "111")
        resultado_esperado = ['Zuelo', 'POLICIA', 'Caio']
        resultado = phonebook.get_phonebook_reverse()
        assert resultado == resultado_esperado

    def test_delete(self):
        phonebook = Phonebook()
        phonebook.add("Andre", "333")
        resultado = phonebook.delete('Andre')
        resultado_esperado = 'Numero deletado'
        assert resultado == resultado_esperado

    def test_change_number(self):
        phonebook = Phonebook()
        phonebook.add("Andre", "456")
        resultado = phonebook.change_number('Andre', '789')
        resultado_esperado = 'Numero alterado com sucesso'
        assert resultado == resultado_esperado
